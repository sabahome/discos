        ...
        try {
            ...
            if (reply.is_success_reply()) {
                for (int j=0;j<m_sectionsNumber;j++)
                    ...
                    if (m_CK==true /*m_SK00==true || m_SC00==true || m_SK00S==true || m_SC00S==true || m_SK77==true || m_SK77S==true || m_SK03==true || m_SK03S==true || m_SK06==true || m_SK06S==true || m_SK01==true || m_SK01S==true
